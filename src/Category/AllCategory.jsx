...
const products = [
    { name: "Travel Luggage", image: "/Meeting.png" },
    { name: "Backpacks", image: "/Meeting.png" },
    { name: "Handbags & Purses", image: "/Meeting.png" },
    { name: "Duffel & Gym Bags", image: "/Meeting.png" },
    { name: "Laptop & Office Bags", image: "/Meeting.png" },
    { name: "Kids Bags", image: "/Meeting.png" },
    { name: "Travel Accessories", image: "/Meeting.png" },
    { name: "Specialty Bags", image: "/Meeting.png" },
];
                    ...
                    <div className="mt-5 space-y-2 max-h-[500px] lg:max-h-none overflow-y-auto pr-1">
                        {categories.map((item, index) => (
                            <button
                                ...
                                className={`w-full flex items-center justify-between px-4 h-14 rounded-xl transition-all duration-300 text-left ${selectedCategory === index
                            ...
                            >
                                <div className="flex items-center gap-3 min-w-0">
                                    <span
                                        className={`w-2.5 h-2.5 rounded-full shrink-0 ${selectedCategory === index
                                                ? "bg-[#635bff]"
                                                : "bg-gray-300"
                                            }`}
                                    />
                                ...
                                <span
                                    className={`w-6 h-6 rounded-md border flex items-center justify-center shrink-0 ${selectedCategory === index
